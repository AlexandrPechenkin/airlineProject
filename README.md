...
Таск-борд находится прямо на [Gitlab](https://gitlab.com/IllIloIs/airline_project/-/boards).
...
<li>изучи <a href="https://gitlab.com/IllIloIs/airline_project/-/boards">таск-борд</a>
</ol>
...
<ul>
<li><code>Backlog / Future</code> задачи, выполнение которых отложено на более отдалённый срок</li>
